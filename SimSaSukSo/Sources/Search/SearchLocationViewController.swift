...
//  SimSaSukSo
//
//  Created by 소영 on 2021/07/31.
//

import UIKit

class SearchLocationViewController: UIViewController, UIGestureRecognizerDelegate {
...
extension SearchLocationViewController : UITableViewDataSource,RegionCellDelegate{
    ...
    func didPressButton(for index: Int, clicked: Bool) {
            if clicked == true{
                ...
                selectButton.backgroundColor = #colorLiteral(red: 0, green: 0.8431372549, blue: 0.6705882353, alpha: 1)
