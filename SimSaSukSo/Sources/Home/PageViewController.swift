...
class PageViewController: UIPageViewController {
    ...
    let viewList : [UIViewController] = {
        ...
        let vc0 = storyBoard.instantiateViewController(identifier: "HomeTabViewController")
        let vc1 = storyBoard.instantiateViewController(identifier: "BestTabViewController")
        let vc2 = storyBoard.instantiateViewController(identifier: "NewTabViewController")
